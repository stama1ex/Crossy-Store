  ...
  (
    ...
    return (
      <SliderPrimitive.Root
        ...
        className={cn(
          'relative flex w-[80%] mx-auto touch-none select-none mb-6 items-center', // Базовый стиль: 80% ширина с отступами
          'md:w-full md:mx-0', // На ПК (≥768px): 100% ширина, без отступов
          className
        )}
        {...props}
      >
